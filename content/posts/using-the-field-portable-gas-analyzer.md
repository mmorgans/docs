...
2.  Set valves 1, 2, and 3 to their backflush positions.
...
{{< alert2 Warning >}}
**Step 2 needs writing down properly, at the instrument.** The valve directions I had here previously contradicted the valve map — two of the three "backflush" positions were the same as the valve's normal position, which can't be right. Rather than leave plausible-looking instructions that don't work, I've left the step abstract. Trace it once with the case open and the pump off, confirm which way each handle actually goes, and write it on the inside of the lid. This is the procedure that protects the most expensive part of the instrument; it deserves ten minutes of somebody's attention.
{{< /alert2 >}}
