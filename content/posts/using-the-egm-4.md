...
#### Linear vs. Quadratic {#linear-vs-dot-quadratic}
...
**1. Linear Fit (`1`):** This method assumes that the accumulation is a straight line (\\(C = C\_0 + kt\\)). You should choose it for short measurement periods, typically under 2 minutes, or low-flux soils.

**2. Quadratic Fit (`2`):** As CO₂ accumulates in the chamber, the concentration gradient decreases, causing the flux rate to slow down or level off. This method accounts for this by fitting a curve to the data (\\(C = C\_0 + kt + ct^2\\)).
