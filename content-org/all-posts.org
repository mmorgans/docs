...
3. Press Enter
4. A window appears with text—this is your command prompt (command prompt is exclusive to Windows; it is /a/ terminal. It has also been around since the 80s: PowerShell is Microsoft's attempt at an updated terminal for Windows.)
